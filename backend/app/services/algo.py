...
def CalculerMensualite39_bis2_ANCIEN(N,C2,T,ASSU,apport,mois,annee,fraisAgence,fraisNotaire,TRAVAUX,revalorisationBien):
    CDEPART = C2
    ...
    return {
        ...
        'output13' : output13.to_dict(orient='records'),
        'TRAVAUX' : TRAVAUX
    }
    


# print(CalculerMensualite39_bis2_ANCIEN(25,200000,4,0.3,0,"02","2025",3,2.5,0,1))

# test = CalculerMensualite39_bis2_ANCIEN(
#     N= 25,
#     C2= 834000,
#     T= 3.5,
#     ASSU= 0.32,
